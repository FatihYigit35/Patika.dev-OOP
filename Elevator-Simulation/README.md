## We draw a UML Diagram using the principles of Object Oriented Programming and relations between classes.
...
## UML Diagram
![ElevatorSimulation UML Diagram](./ElevatorSimulation.png)
